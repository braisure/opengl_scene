...
public class AABB3 {
    ...
    /**
	 * 和参数射线的相交性测试
     * 若不相交，返回值是一个非常大的数(大于1)；若相交，返回相交时间t（t为0-1之间的值）
     * step1 --- 先判断矩形边界框的哪个面会相交
	 * step2 --- 再检测射线与包含这个面的平面的相交性
	 * 如果交点在盒子中，那么射线与矩形边界框相交，否则不存在相交
	 */
